...
const DEFAULT_HERO = {
  ...
  primaryCTA: 'Start Test',
  secondaryCTA: 'View Code',
  primaryCTAHref: '/test',
  secondaryCTAHref: '#code',
  imageUrl:
    'https://images.unsplash.com/photo-1551650975-87deedd944c3?q=80&w=1920&auto=format&fit=crop',
  imageAlt: 'Test website preview',
  statsLabel1: 'Load Time',
  statsValue1: '< 1 second',
  statsLabel2: 'Test Score',
  statsValue2: '100% pass',
} as const;
