...
const DEFAULT_FOOTER = {
  logoText: 'TestSite',
  companyDescription:
    'A simple test website showcasing modern web development with clean, minimal design. Perfect for testing and demonstration purposes.',
  contactEmail: 'hello@testsite.com',
  contactPhone: '+1 (555) 123-4567',
  contactAddress: '123 Test Street, Demo City',
  newsletterTitle: 'Stay Updated',
  newsletterPlaceholder: 'Enter your email',
  newsletterDisclaimer: 'Get the latest updates and offers. No spam, unsubscribe anytime.',
  section1Title: 'Company',
  section2Title: 'Resources',
  section3Title: 'Legal',
  ...
  social4Href: '#',
  social5Href: '#',
  // Company Links (1 item as required)
  linkFeatures: 'About',
  linkFeaturesHref: '#hero',
  linkPricing: 'Features',
  linkPricingHref: '#features',
  linkTemplates: 'Services',
  linkTemplatesHref: '#services',
  linkIntegrations: 'Contact',
  linkIntegrationsHref: '#contact',
  linkApi: 'Blog',
  linkApiHref: '/blog',
  linkDocumentation: 'Help',
  linkDocumentationHref: '/help',
  // Resources Links (0 items as required - keeping structure but hiding)
  linkAbout: 'Documentation',
  linkAboutHref: '/docs',
  linkBlog: 'Tutorials',
  linkBlogHref: '/tutorials',
  linkCareers: 'Community',
  linkCareersHref: '/community',
  linkPress: 'Support',
  linkPressHref: '/support',
  linkPartners: 'Status',
  linkPartnersHref: '/status',
  linkContact: 'Updates',
  linkContactHref: '/updates',
  // Legal Links (2 items as required)
  linkHelp: 'Privacy',
  linkHelpHref: '/privacy',
  linkCommunity: 'Terms',
  linkCommunityHref: '/terms',
  linkTutorials: 'Cookies',
  linkTutorialsHref: '/cookies',
  linkWebinars: 'Security',
  linkWebinarsHref: '/security',
  linkCaseStudies: 'Compliance',
  linkCaseStudiesHref: '/compliance',
  linkStatus: 'GDPR',
  linkStatusHref: '/gdpr',
  // Legal Links
  linkPrivacy: 'Privacy',
